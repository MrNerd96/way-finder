...
var I18N = (function () {
  var STR = {
    en: {
      ...
      howUp: 'How you go between floors — tap to change',
      way_lift: 'Lift',
      way_chair: 'Wheelchair',
      way_steps: 'Steps',
      noSuchWay: 'No route that way. This is the only way there.',
    ...
    te: {
      ...
      howUp: 'అంతస్తుల మధ్య ఎలా — మార్చడానికి నొక్కండి',
      way_lift: 'లిఫ్ట్',
      way_chair: 'వీల్‌చైర్',
      way_steps: 'మెట్లు',
      noSuchWay: 'ఆ దారి లేదు. ఉన్నది ఇదొక్కటే.',
    ...
    hi: {
      ...
      howUp: 'मंज़िल कैसे बदलेंगे — बदलने के लिए दबाइए',
      way_lift: 'लिफ्ट',
      way_chair: 'व्हीलचेयर',
      way_steps: 'सीढ़ी',
      noSuchWay: 'वह रास्ता नहीं है. यही एक रास्ता है.',
