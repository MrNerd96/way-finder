...
var I18N = (function () {
  var STR = {
    en: {
      ...
      startPlaceholder: 'Lift, staircase or entrance',
      pickStart: 'Your location',
      pickDest: 'Your destination',
      noMatch: 'Nothing found. Try a room number, or ask at the help desk.',
      /* The start list holds no room numbers, so telling someone to try one --
         which the shared noMatch does -- sends them round in circles. */
      noMatchStart: 'Nothing found. Choose the lift, a staircase or the entrance nearest you, or ask at the help desk.',
    ...
    te: {
      ...
      startPlaceholder: 'లిఫ్ట్, మెట్లు లేదా ప్రవేశ ద్వారం',
      pickStart: 'మీ స్థానం',
      pickDest: 'మీ గమ్యం',
      noMatch: 'ఏమీ దొరకలేదు. గది నంబరు ప్రయత్నించండి లేదా సహాయ కేంద్రంలో అడగండి.',
      noMatchStart: 'ఏమీ దొరకలేదు. మీకు దగ్గరలో ఉన్న లిఫ్ట్, మెట్లు లేదా ప్రవేశ ద్వారం ఎంచుకోండి, లేదా సహాయ కేంద్రంలో అడగండి.',
    ...
    hi: {
      ...
      startPlaceholder: 'लिफ़्ट, सीढ़ी या प्रवेश द्वार',
      pickStart: 'आपकी जगह',
      pickDest: 'आपकी मंज़िल',
      noMatch: 'कुछ नहीं मिला. कमरा नंबर आज़माइए या हेल्प डेस्क पर पूछिए.',
      noMatchStart: 'कुछ नहीं मिला. अपने पास की लिफ़्ट, सीढ़ी या प्रवेश द्वार चुनिए, या हेल्प डेस्क पर पूछिए.',
