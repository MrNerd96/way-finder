...
var I18N = (function () {
  var STR = {
    en: {
      ...
      startPlaceholder: 'Room number, lift or staircase',
      pickStart: 'Your location',
      pickDest: 'Your destination',
      noMatch: 'Nothing found. Try a room number, or ask at the help desk.',
      /* The two lists hold different things -- the destination list is every
         named room, the start list is those plus the lifts, staircases and
         landmarks -- so each needs advice that fits what it actually contains. */
      noMatchStart: 'Nothing found. Try the number on the nearest door, or the lift or staircase you came from.',
      ...
      rampUp: 'Go UP the RAMP',
      rampDown: 'Go DOWN the RAMP',
      stairUp: 'Take the STAIRS UP',
      stairDown: 'Take the STAIRS DOWN',
      toFloor: 'to floor',
      startAt: 'Start here',
    ...
    te: {
      ...
      startPlaceholder: 'గది నంబరు, లిఫ్ట్ లేదా మెట్లు',
      pickStart: 'మీ స్థానం',
      pickDest: 'మీ గమ్యం',
      noMatch: 'ఏమీ దొరకలేదు. గది నంబరు ప్రయత్నించండి లేదా సహాయ కేంద్రంలో అడగండి.',
      noMatchStart: 'ఏమీ దొరకలేదు. దగ్గరలోని తలుపు మీద ఉన్న నంబరు, లేదా మీరు వచ్చిన లిఫ్ట్ లేదా మెట్లు ప్రయత్నించండి.',
      ...
      rampUp: 'ర్యాంప్ మీద పైకి వెళ్లండి',
      rampDown: 'ర్యాంప్ మీద కిందికి వెళ్లండి',
      stairUp: 'మెట్లు ఎక్కి పైకి వెళ్లండి',
      stairDown: 'మెట్ల మీద కిందికి దిగండి',
      toFloor: 'అంతస్తుకు',
    ...
    hi: {
      ...
      startPlaceholder: 'कमरा नंबर, लिफ़्ट या सीढ़ी',
      pickStart: 'आपकी जगह',
      pickDest: 'आपकी मंज़िल',
      noMatch: 'कुछ नहीं मिला. कमरा नंबर आज़माइए या हेल्प डेस्क पर पूछिए.',
      noMatchStart: 'कुछ नहीं मिला. पास के दरवाज़े पर लिखा नंबर आज़माइए, या जिस लिफ़्ट या सीढ़ी से आए हैं वह चुनिए.',
      ...
      rampUp: 'रैंप से ऊपर जाइए',
      rampDown: 'रैंप से नीचे जाइए',
      stairUp: 'सीढ़ी से ऊपर जाइए',
      stairDown: 'सीढ़ी से नीचे जाइए',
      toFloor: 'मंज़िल पर',
