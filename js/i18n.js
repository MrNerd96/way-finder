...
var I18N = (function () {
  var STR = {
    en: {
      ...
      stepFree: 'No stairs',
      stepFreeHint: 'Use lifts and ramps only',
      noStepFree: 'No step-free way there. This route uses stairs.',
    ...
    te: {
      ...
      stepFree: 'మెట్లు వద్దు',
      stepFreeHint: 'లిఫ్ట్, ర్యాంప్ మాత్రమే',
      noStepFree: 'మెట్లు లేకుండా దారి లేదు. ఈ దారిలో మెట్లు ఉన్నాయి.',
    ...
    hi: {
      ...
      stepFree: 'सीढ़ी नहीं',
      stepFreeHint: 'सिर्फ़ लिफ्ट और रैंप',
      noStepFree: 'बिना सीढ़ी के रास्ता नहीं है. इस रास्ते में सीढ़ी है.',
